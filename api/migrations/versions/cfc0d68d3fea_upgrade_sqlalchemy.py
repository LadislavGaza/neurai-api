...
def upgrade():
    ...
    op.drop_constraint(
        "mri_files_created_by_fkey", "mri_files", type_="foreignkey"
    )
    op.drop_constraint(
        "mri_files_modified_by_fkey", "mri_files", type_="foreignkey"
    )
    op.create_foreign_key(
        "mri_files_created_by_fkey", "mri_files", "users",
        ["modified_by"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        "mri_files_modified_by_fkey", "mri_files", "users",
